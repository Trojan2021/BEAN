...
func TestInlineCode(t *testing.T) {
	tests := []struct {
		...
		// Inline Code Testing
		{
			...
			input:    []string{"`code`"},
			expected: "\033[48;5;238;38;5;1mcode\033[39;49m",
		},
		{
			name:     "Plain in-line code block (emphasis within code block)",
			input:    []string{"`**_~~code~~_**`"},
			expected: "\033[48;5;238;38;5;1m**_~~code~~_**\033[39;49m",
		},
		{
			name:     "Used in a paragraph (single-line)",
			input:    []string{"Paragraph with `code` in it."},
			expected: "Paragraph with \033[48;5;238;38;5;1mcode\033[39;49m in it.",
		},
		{
		...
		},
		{
			...
			expected: "\033[1mParagraph\033[0m \033[3mwith\033[0m \033[48;5;238;38;5;1mcode\033[39;49m \033[9min it\033[0m \033[48;5;238;38;5;1m**and such**\033[39;49m. Code blocks can be \033[1m\033[3m\033[9m\033[48;5;238;38;5;1memphasized\033[39;49m\033[0m\033[0m\033[0m\nexternally.",
		},
		{
			name:     "Used in a list",
			input:    []string{"- List parent", "\t- List child with `code` in it."},
			expected: "• List parent\n    ‣ List child with \033[48;5;238;38;5;1mcode\033[39;49m in it.",
		},
		{
